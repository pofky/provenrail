...
export const steps: Step[] = [
  {
    ...
    lines: [
      ...
      { kind: "out", text: "Armed guardrails in .provenrail.json: destructive, secrets, production", tone: "ok" },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "out", text: "argument contains a recursive or forced rm", tone: "dim" },
      { kind: "blank" },
